                             ...
                             <div class="col-md-3 pull-right panel-padding">
                                <table class="table border table-striped table-margintop">
                                    <tbody>
                                        ...
                                        <tr class="project-overview">
                                          <?php $total_goods_discount = (isset($goods_receipt) ? $goods_receipt->total_goods_discount : '');?>

                                          <td ><?php echo render_input('total_goods_discount','Discount',"-".app_format_money((float)$total_goods_discount,''),'',array('disabled' => 'true')) ?>
                                            <?php echo form_hidden('total_goods_discount', $total_goods_discount); ?>
                                          </td>
                                       </tr>
