          ...
          <div class="panel-body">
            ...
            <div class="row">
                    ...
                    <div class="row">    
                          ...
                          <?php } ?>
                              <br><br>
                              <a href="javascript:void(0)" onclick="getSelectedDeliveryNotes()" class="btn btn-success pull-left mright10 display-block">
                                  <?php echo _l('Multiple DN to Invoice'); ?>
                              </a>
                              <input type="hidden" name="system_base_url" id="system_base_url" value="<?php echo base_url('admin/invoices/invoice?d_note='); ?>" />
                          </div>
