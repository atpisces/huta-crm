          ...
          <div class="panel-body">
            ...
            <div class="row">
            	<div class="col-md-6">
	                ...
	                <div class="col-md-6 pad_left_0 ">
	                	<?php $subtotal = ( isset($pur_invoice) ? $pur_invoice->subtotal : '');
	                	echo render_input('subtotal','invoice_amount',$subtotal,'text', array('onchange' => 'subtotal_change(this); return false;' ),[],'','text-right'); ?>
	                </div>
	                ...
	                <div class="col-md-6 pad_left_0">
	                	...
	                	$tax = ( isset($pur_invoice) ? $pur_invoice->tax : '');
	                	echo render_input('tax','tax_value',$tax,'number', $attr,[],'','text-right'); ?>
	                </div>

	                <div class="col-md-6 pad_right_0">
	                	<?php $total = ( isset($pur_invoice) ? $pur_invoice->total : '');
	                	echo render_input('total','total_included_tax',$total,'number', array('step' => 0.01),[],'','text-right'); ?>
	                </div>
