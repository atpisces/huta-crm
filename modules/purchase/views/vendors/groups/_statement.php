       ...
       foreach($statement['result'] as $data){ ?>
         <tr>
           ...
           <td>
            ...
            echo _l('statement_credit_note_details',array('<a href="'.admin_url('purchase/debit_notes/'.$data['credit_note_id']).'" target="_blank">'.format_credit_note_number($data['credit_note_id']).'</a>'));
            ...
            echo _l('statement_credits_applied_details',array(
              ...
              get_pur_invoice_number($data['credit_invoice_id'])
            )
          );
