...
{   
    ...
    public function update_purchase_setting($data)
    {
        ...
        if($data['input_name'] != 'show_purchase_tax_column'){
...
/**
    ...
    $html = '<table class="table">
        <tbody>
          <tr>
            <td class="font_td_cpn" style="width: 70%">'. _l('purchase_company_name').': '. $company_name.'</td>
            <td rowspan="2" style="width: 30%" class="text-right">'.get_po_logo(150, "img img-responsive").'</td>
