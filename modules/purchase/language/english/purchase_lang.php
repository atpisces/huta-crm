...
$lang['coppy_pur_request'] = 'Copy the purchase request to the estimate detail table!';
...
$lang['create_new_pur_order'] = 'Create a new purchase order';
$lang['pur_order_detail'] = 'Purchase order detail';
$lang['by_item'] = 'By item';
$lang['by_order'] = 'By order';
$lang['pur_order_name'] = 'Purchase order name';
$lang['not_start'] = 'Not started';
$lang['in_proccess'] = 'In Progress';
...
$lang['coppy_pur_estimate'] = 'Copy estimate to purchase order detail table!';
$lang['date_request'] = 'Requested date';
...
$lang['please_chose_pur_order'] = 'Please chose a purchase order first!';
...
$lang['notify_send_request_approve_pur_request'] = 'sent you an approval request on purchase request %s';
...
$lang['notify_send_request_approve_pur_quotation'] = 'sent you an approval request on purchase quotation %s';
...
$lang['send_request_quotation_successfully'] = 'request quotation sent successfully';
$lang['send_request_quotation_fail'] = 'request quotation send fail';
$lang['purchase_order_setting'] = 'General Settings';
$lang['create_purchase_order_non_create_purchase_request_quotation'] = 'Do not create a Purchase request or Quotation';
$lang['purchase_order_tooltip'] = 'If checkbox is checked, you will createa a "Puchase order" not a "Puchase request", "Quotation" ';
...
$lang['cost_of_import_goods_for_each_item'] = 'Cost of imported goods for each item';
...
$lang['new_approval_setting'] = 'New approval';
$lang['edit_approval_setting'] = 'Edit approval';
...
$lang['create_public_link'] = 'Create a public link';
...
$lang['send_request_approve_pur'] = 'Send an approval request';
...
$lang['notify_send_request_approve_pur_inv'] = 'sent you an approval request on %s';
...
$lang['please_chose_pur_estimate'] = 'Please chose an estimate!';
...
$lang['send_po_successfully'] = 'purchase order sent successfully!';
$lang['send_po_fail'] = 'purchase order failed to send';
$lang['send_quotation_successfully'] = 'Send quotation successfully!';
$lang['send_quotation_fail'] = 'quotation failed to send!';
...
$lang['file_xlsx_commodity'] = 'The column with "*" is required, Column "Unit", "Commodity Group", "Sub group" can enter "ID" or Code of type ';
$lang['file_xlsx_tax'] = 'The column "Tax", enter "ID" of tax or "tax name" ';
$lang['file_xlsx_format'] = 'Please format your excel file to (type : text) before uploading';
...
$lang['reset_data_title_pur'] = 'All Purchase data: Purchase requests, Quotations, Purchase Orders, Purchase Contacts, Purchase Invoices will be deleted';
$lang['po_logo'] = 'Logo to be displayed on Purchase Order';
$lang['po_report'] = 'Purchase Order Report';
$lang['remove_po_logo'] = 'Remove last purchase order logo';
...
$lang['coppy_pur_request_to_purorder'] = 'Copy the purchase request to the purchase order detail table';
$lang['already_exist'] = 'Already exists';
$lang['first_name'] = 'First Name';
$lang['last_name'] = 'Last Name';
$lang['change_delivery_status_successfully'] = ' delivery status changed successfully!';
...
$lang['converted_succesfully'] = 'Converted successfully';
$lang['no_payments_are_converted'] = 'No payments were converted';
...
$lang['please_chose_sale_invoice'] = 'Please chose the sale invoice';
$lang['please_enter_data'] = 'Please enter full data!';
$lang['additional_content'] = 'Additional content';
$lang['pur_send'] = 'Send';
$lang['attach_purchase_order_pdf'] = 'Attach a Purchase Order PDF';
