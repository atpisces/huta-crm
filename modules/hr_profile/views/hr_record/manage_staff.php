...
<div id="wrapper">
					...
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-md-12">
								...
								array_push($table_data,"Iqama Status");
								array_push($table_data,"Passport Status");
								array_push($table_data,"Medical Insurance Status");
	...
	<!-- Modal -->
	<div id="extendDateModal" class="modal fade" role="dialog">
	  <div class="modal-dialog">
	    ...
	    <div class="modal-content">
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title" id="expirymodaltitle">Extend Iqama Date</h4>
	      </div>
	      <div class="modal-body">
	      	<?php echo form_open('admin/hr_profile/add_extend_status_date'); ?>
	      		<input type="hidden" name="staffid" id="staffid">
	      		<input type="hidden" name="statustype" id="statustype">
		        <div class="row">
		        	<div class="col-md-4">
		        		<label>Years</label>
		        		<input type="text" name="extend_duration[]" id="years_extend_duration" class="form-control" value="0" placeholder="Years">
		        	</div>
		        	<div class="col-md-4">
		        		<label>Months</label>
		        		<input type="text" name="extend_duration[]" id="months_extend_duration" class="form-control" value="0" placeholder="Months">
		        	</div>
		        	<div class="col-md-4">
		        		<label>Days</label>
		        		<input type="text" name="extend_duration[]" id="days_extend_duration" class="form-control" value="0" placeholder="Days">
		        	</div>
		        </div>
		        <div class="row">
		        	<br><br>
...
?>
	<!-- Modal -->
	<div id="viewIqamaHistoryModal<?php echo $staff["staffid"]; ?>" class="modal fade" role="dialog">
	  <div class="modal-dialog">
	    <!-- Modal content-->
	    <div class="modal-content">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal">&times;</button>
	        <h4 class="modal-title">Iqama Date Extension History</h4>
	      </div>
	      <div class="modal-body">
	      	<?php //print_r($staff_list); ?>
	      	<?php //print_r($statuses_records); ?>
	    ...
	    ?>
	        		<tr>
		        		<td><?php echo $n; ?></td>
		        		<td><?php echo date("d-m-Y",strtotime($record["old_date"])); ?></td>
		        		<td><?php echo "<b>".$extend_duration[0]."</b>year(s) <b>".$extend_duration[1]."</b>month(s) <b>".$extend_duration[2]."</b>day(s)"; ?></td>
		        		<td><?php echo date("d-m-Y",strtotime($record["new_date"])); ?></td>
		        	</tr>
		<?php   
				$n++; }
			 }
...
?>
	<!-- Modal -->
	<div id="viewPassportHistoryModal<?php echo $staff["staffid"]; ?>" class="modal fade" role="dialog">
	  <div class="modal-dialog">
	    <!-- Modal content-->
	    <div class="modal-content">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal">&times;</button>
	        <h4 class="modal-title">Passport Date Extension History</h4>
	      </div>
	      <div class="modal-body">
	      	<?php //print_r($staff_list); ?>
	      	<?php //print_r($statuses_records); ?>
...
?>
	<!-- Modal -->
	<div id="viewMedicalInsuranceHistoryModal<?php echo $staff["staffid"]; ?>" class="modal fade" role="dialog">
	  <div class="modal-dialog">
	    <!-- Modal content-->
	    <div class="modal-content">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal">&times;</button>
	        <h4 class="modal-title">Medical Insurance Date Extension History</h4>
	      </div>
	      <div class="modal-body">
	      	<?php //print_r($staff_list); ?>
	      	<?php //print_r($statuses_records); ?>
