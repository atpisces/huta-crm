					...
					<div class="panel-body">
						<div class="widget" id="widget-<?php echo basename(__FILE__,".php"); ?>" data-name="<?php echo _l('hr_hr_profile'); ?>">
							<div class="row">
								<div class="col-md-12">
									<div class="col-md-6">
										<p class="text-dark text-uppercase bold">REPORTS</p>
									</div>
									...
									<hr class="mtop15" />
									<div class="col-md-12">
										<a href="<?php echo admin_url('hr_profile/user_status_report'); ?>" class="btn mright5 btn-info pull-left display-block hidden-xs">User Status Report</a>
										<br><br>
									</div>
									<br><br>
									<hr class="mtop15" />
