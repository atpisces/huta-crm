...
<div id="wrapper">
   <div class="content">
      <div class="row">
         ...
         <div class="col-md-6">
            <div class="panel_s" id="moreexpenses">
               <div class="panel-body">
                  ...
                  <div class="btn-bottom-toolbar text-right">
                     <button type="button" class="btn btn-info" onclick="addMoreExpense()"><?php echo _l('Add More'); ?></button>
                  </div>
                  <div class="btn-bottom-toolbar text-right">
                     <button type="button" class="btn btn-success" onclick="addMoreExpense()"><?php echo _l('Add More'); ?></button>
                     <br><br>
