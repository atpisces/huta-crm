...
$html = '<h1>Wahid' . _l('project_name') . ': ' . $project->name . '</h1>';
...
$pdf->Ln(5);
$html = '';
$html .= '<p><b style="background-color:#f0f0f0;">' . ucwords(_l('Files Overview')) . '</b></p>';
$html .= '<table width="100%" bgcolor="#fff" cellspacing="0" cellpadding="5" border="1">';
$html .= '<thead>';
$html .= '<tr bgcolor="#323a45" style="color:#ffffff;">';
$html .= '<th><b>' . _l('File Name') . '</b></th>';
$html .= '<th><b>' . _l('File Type') . '</b></th>';
$html .= '<th><b>' . _l('Last Activity') . '</b></th>';
$html .= '<th><b>' . _l('Visible to Customer') . '</b></th>';
$html .= '<th><b>' . _l('Uploaded by') . '</b></th>';
$html .= '<th><b>' . _l('Uploaded Date') . '</b></th>';
$html .= '</tr>';
$html .= '</thead>';
$html .= '<tbody>';
foreach ($files as $file) {
    $html .= '<tr style="color:#4a4a4a;">';
    $html .= '<td width="20%">' . $file['file_name'] . '</td>';
    $html .= '<td width="30%">' . $file['filetype'] . '</td>';
    $html .= '<td width="30%">' . $file['last_activity'] . '</td>';
    $html .= '<td width="15%">' . $file['visible_to_customer'] . '</td>';
    $html .= '<td width="15%">' . $file['staffid'] . '</td>';
    $html .= '<td width="20%">' . date("d M, Y",strtotime($file['dateadded'])) . '</td>';
    $html .= '</tr>';
}
$html .= '</tbody>';
$html .= '</table>';
// Write Files table data
$pdf->writeHTML($html, true, false, false, false, '');

// Discussions overview
$pdf->Ln(5);
$html = '';
$html .= '<p><b style="background-color:#f0f0f0;">' . ucwords(_l('Discussions Overview')) . '</b></p>';
$html .= '<table width="100%" bgcolor="#fff" cellspacing="0" cellpadding="5" border="1">';
$html .= '<thead>';
$html .= '<tr bgcolor="#323a45" style="color:#ffffff;">';
$html .= '<th><b>' . _l('Subject') . '</b></th>';
$html .= '<th><b>' . _l('Description') . '</b></th>';
$html .= '<th><b>' . _l('Last Activity') . '</b></th>';
$html .= '<th><b>' . _l('Creation Date') . '</b></th>';
$html .= '</tr>';
$html .= '</thead>';
$html .= '<tbody>';
foreach ($discussions as $discussion) {
    $html .= '<tr style="color:#4a4a4a;">';
    $html .= '<td width="20%">' . $discussion['subject'] . '</td>';
    $html .= '<td width="30%">' . $discussion['description'] . '</td>';
    $html .= '<td width="30%">' . $discussion['last_activity'] . '</td>';
    $html .= '<td width="30%">' . $discussion['datecreated'] . '</td>';
    $html .= '</tr>';
}
$html .= '</tbody>';
$html .= '</table>';
// Write Discussions table data
$pdf->writeHTML($html, true, false, false, false, '');

// Tickets overview
$pdf->Ln(5);
$html = '';
$html .= '<p><b style="background-color:#f0f0f0;">' . ucwords(_l('Tickets Overview')) . '</b></p>';
$html .= '<table width="100%" bgcolor="#fff" cellspacing="0" cellpadding="5" border="1">';
$html .= '<thead>';
$html .= '<tr bgcolor="#323a45" style="color:#ffffff;">';
$html .= '<th><b>' . _l('Subject') . '</b></th>';
$html .= '<th><b>' . _l('Department') . '</b></th>';
$html .= '<th><b>' . _l('Service') . '</b></th>';
$html .= '<th><b>' . _l('Contact') . '</b></th>';
$html .= '<th><b>' . _l('Status') . '</b></th>';
$html .= '<th><b>' . _l('Priority') . '</b></th>';
$html .= '<th><b>' . _l('Creation Date') . '</b></th>';
$html .= '</tr>';
$html .= '</thead>';
$html .= '<tbody>';
foreach ($tickets as $ticket) {
    $html .= '<tr style="color:#4a4a4a;">';
    $html .= '<td width="20%">' . $ticket['subject'] . '</td>';
    $html .= '<td width="30%">' . $ticket['department'] . '</td>';
    $html .= '<td width="30%">' . $ticket['service'] . '</td>';
    $html .= '<td width="30%">' . $ticket['contactid'] . '</td>';
    $html .= '<td width="30%">' . $ticket['status'] . '</td>';
    $html .= '<td width="30%">' . $ticket['priority'] . '</td>';
    $html .= '<td width="30%">' . $ticket['date'] . '</td>';
    $html .= '</tr>';
}
$html .= '</tbody>';
$html .= '</table>';
// Write Tickets table data
$pdf->writeHTML($html, true, false, false, false, '');

// Contracts overview
$pdf->Ln(5);
$html = '';
$html .= '<p><b style="background-color:#f0f0f0;">' . ucwords(_l('Contracts Overview')) . '</b></p>';
$html .= '<table width="100%" bgcolor="#fff" cellspacing="0" cellpadding="5" border="1">';
$html .= '<thead>';
$html .= '<tr bgcolor="#323a45" style="color:#ffffff;">';
$html .= '<th><b>' . _l('Subject') . '</b></th>';
$html .= '<th><b>' . _l('Customer') . '</b></th>';
$html .= '<th><b>' . _l('Contract Type') . '</b></th>';
$html .= '<th><b>' . _l('Contract Value') . '</b></th>';
$html .= '<th><b>' . _l('Start Date') . '</b></th>';
$html .= '<th><b>' . _l('End Date') . '</b></th>';
$html .= '</tr>';
$html .= '</thead>';
$html .= '<tbody>';
foreach ($contracts as $contract) {
    $html .= '<tr style="color:#4a4a4a;">';
    $html .= '<td width="20%">' . $contract['subject'] . '</td>';
    $html .= '<td width="30%">' . $contract['client'] . '</td>';
    $html .= '<td width="30%">' . $contract['contract_type'] . '</td>';
    $html .= '<td width="30%">' . $contract['contract_value'] . '</td>';
    $html .= '<td width="30%">' . date("d M, Y",strtotime($contract['dateadded'])) . '</td>';
    $html .= '<td width="30%">' . date("d M, Y",strtotime($contract['acceptance_date'])) . '</td>';
    $html .= '</tr>';
}
$html .= '</tbody>';
$html .= '</table>';
// Write Contracts table data
$pdf->writeHTML($html, true, false, false, false, '');
