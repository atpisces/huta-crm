      ...
      <div class="row">
         ...
         <div class="col-md-6">
            ...
            <div class="form-group">
              <input type="text" name="new_invoice_no" placeholder="Invoice No. (New Format)" class="form-control">
            </div>
            <?php
         ...
         <!-- <div class="col-md-12">
          <table class="table table-sm">
            ...
            <tbody id="allrows">
              <tr>
                <td>
                  <select name="extra_fields_type[]" class="form-control">
                ...
                <td>
                  <input type="text" name="extra_fields_amount[]" class="form-control" placeholder="Amount">
                </td>
                <td>
                  <input type="number" name="extra_fields_vat[]" class="form-control" placeholder="VAT">
                </td>
                <td></td>
              </tr>
            </tbody>
...
<script>  
  ...
  <?php
    $rinc = 1;
    if(isset($invoice)){
      foreach($extra_fields_data as $extra){
  ?>
              <tr id="rowsection<?php echo $rinc; ?>">
                <td>
                  <select name="extra_fields_type[]" class="form-control">
                    <option value="" selected>Select Type</option>
                    <option value="Recovery" <?php if($extra["fieldtype"] == "Recovery"){ echo "selected"; } ?>>Recovery</option>
                    <option value="Retention" <?php if($extra["fieldtype"] == "Retention"){ echo "selected"; } ?>>Retention</option>
                    <option value="Deduction" <?php if($extra["fieldtype"] == "Deduction"){ echo "selected"; } ?>>Deduction</option>
                  </select>
                </td>
                <td>
                  <textarea name="extra_fields_description[]" class="form-control" placeholder="Description" rows="2"><?php echo $extra["fielddescription"]; ?></textarea>
                </td>
                <td>
                  <input type="text" name="extra_fields_amount[]" value="<?php echo $extra["fieldamount"]; ?>" class="form-control" placeholder="Amount">
                </td>
                <td>
                  <input type="number" name="extra_fields_vat[]" value="<?php echo $extra["fieldvat"]; ?>" class="form-control" placeholder="VAT">
                </td>
                <td>
          <div><a href="javascript:void(0)" style="background-color: #bb2d3b; color: #ffffff; padding: 5px; border-radius: 5px;" onclick="removeSection(<?php echo $rinc; ?>)"><i class="fa fa-trash fa-1x"></i></a></div>
        </td>
              </tr>
  <?php
        $rinc++;
  ...
  ?>
              <!--<tr>
                ...
                <td>
                  <textarea name="extra_fields_description[]" class="form-control" placeholder="Description" rows="2"></textarea>
                </td>
                <td>
                  <input type="text" name="extra_fields_amount[]" class="form-control" placeholder="Amount">
                </td>
