         ...
         <div class="col-md-6">
            <div class="panel_s no-shadow">
               ...
               <div class="form-group mbot15 select-placeholder">
                  ...
                  <?php } else { ?>
                  <p>asdfasdf<?php echo _l('invoice_add_edit_no_payment_modes_found'); ?></p>
      ...
      <div class="row">
         ...
         <div class="col-md-<?php if(!isset($invoice_from_project)){ echo 5; }else {echo 8;} ?> text-right show_quantity_as_wrapper">
            <div class="mtop10">
               ...
               <div class="radio radio-primary radio-inline">
                  <input type="radio" value="2" id="sq_2" name="show_quantity_as" data-text="<?php echo _l('invoice_table_hours_heading'); ?>" <?php if(isset($invoice) && $invoice->show_quantity_as == 2 || isset($hours_quantity)){echo 'checked';} ?>z>
