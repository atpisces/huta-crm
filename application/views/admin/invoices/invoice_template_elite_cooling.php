         ...
         <table class="table invoice-items-table items table-main-invoice-edit has-calculations no-mtop">
            ...
            <tbody>
               <tr class="main">
                  ...
                  <td>
                     <input type="hidden" name="quantity" min="0" value="1" class="form-control" placeholder="<?php echo _l('item_quantity_placeholder'); ?>">
                     <input type="number" placeholder="<?php echo _l('0-100%'); ?>" data-toggle="tooltip" data-title="0% - 100%" name="unit" class="form-control">
                  </td>
                  <td>
