         ...
         <div class="col-md-6">
            ...
            <div class="form-group">
               ...
               <div class="input-group">
                  ...
                  <input type="text" name="number" class="form-control" value="<?php echo ($_is_draft) ? 'DRAFT' : $_invoice_number; ?>" data-isedit="<?php echo $isedit; ?>" readonly data-original-number="<?php echo $data_original_number; ?>" <?php echo ($_is_draft) ? 'disabled' : '' ?>>
                  <?php if($format == 3) { ?>
                  <span class="input-group-addon">
            ...
            <div class="row">
               <div class="col-md-6">
                  ...
                  $date_attrs = array('disabled' => 'disabled');
   ...
   <div class="panel-body mtop10">
               ...
               <tr>
                  ...
                  foreach($custom_fields as $cf){
                    echo '<th width="15%" align="left" class="custom_field">' . $cf['name'] . '</th>';
                     ...
                     ?>
                  <th style="display: none;" width="10%" align="right" class="qty"><?php echo $qty_heading; ?></th>
      ...
      <div class="col-md-8 col-md-offset-4">
            ...
            <tbody>
               ...
               <tr>
                  <td>
                     <div class="row">
                        <div class="col-md-7">
                           <span class="bold"><?php echo _l('Billable Amount in %'); ?></span>
                        </div>
                        <div class="col-md-5">
                           <input type="number" data-toggle="tooltip" data-title="<?php echo _l('numbers_not_formatted_while_editing'); ?>" value="" class="form-control pull-left" name="billable_amount" onblur="billableAmountFunction(this.value)">
                        </div>
                     </div>
                  </td>
                  <td class="billable-amount-field"><span id="billable-amount-text">SAR0.00</span><input type="hidden" name="billable_amount_field" value="0" id="billable-amount-field"></td>
               </tr>
               <tr id="discount_area">
                  <td>
                     <div class="row">
               ...
               <tr>
                  ...
                  <td class="cutom-tax-amount-field"><span id="cutom-tax-amount-text">SAR0.00</span><input type="hidden" name="cutom_tax_amount_field" value="0" id="cutom-tax-amount-field"></td>
               </tr>
               <tr>
                  <td>
                     <div class="row">
               ...
               <tr id="recovery_payment_area">
                  <td>
                     <div class="row">
                        <div class="col-md-7">
                           <span class="bold">
                            <?php echo _l('Recovery of Advance Payment'); ?>
                         </span>
                        </div>
                        <div class="col-md-5">
                            <div class="input-group" id="recovery-payment-total">

                                <input type="number" value="0" class="form-control pull-left input-recovery-payment" name="recovery_payment" id="recovery_payment" onblur="recoveryOfAdvancePayment(this.value)">
                                <input type="hidden" name="recovery_label_field" id="recovery_label_field" value="%">

                                <div class="input-group-addon">
                                  <div class="dropdown">
                                    <a class="dropdown-toggle" href="#" id="dropdown_menu_tax_total_type" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                      <span class="recovery-payment-type-selected" id="recovery-label">%
                                      </span>
                                      <span class="caret"></span>
                                    </a>
                                    <ul class="dropdown-menu" id="recovery-payment-type-dropdown" aria-labelledby="dropdown_menu_tax_total_type">
                                      <li>
                                        <a href="javascript:void(0)" class="recovery-payment-type recovery-payment-percent<?php if(!isset($invoice) || (isset($invoice) && is_sale_discount($invoice,'percent')) || (isset($invoice) && !is_sale_discount_applied($invoice))){echo ' selected';} ?>" onclick="updateAmountLabel('%','r')">%</a>
                                      </li>
                                      <li><a href="javascript:void(0)" class="recovery-payment-type recovery-payment-fixed<?php if(isset($invoice) && is_sale_discount($invoice,'fixed')){echo ' selected';} ?>" onclick="updateAmountLabel('Fixed Amount','r')">
                                          <?php echo _l('discount_fixed_amount'); ?>
                                        </a>
                                      </li>
                                    </ul>
                  ...
                  <td class="recovery-payment-total"><span id="recovery-payment-total-text">SAR0.00</span><input type="hidden" name="recovery_payment_total_field" id="recovery-payment-total-field" value="0"></td>
               </tr>
               <tr id="withheld_retention_area">
                  <td>
                     <div class="row">
                        <div class="col-md-7">
                           <span class="bold">
                            <?php echo _l('Amount Withheld as Retention'); ?>
                         </span>
                        </div>
                        <div class="col-md-5">
                            <div class="input-group" id="withheld-retention-total">

                                <input type="number" value="0" class="form-control pull-left input-withheld-retention" name="withheld_payment" id="withheld_payment" onblur="amountWithheldAsRetention(this.value)">
                                <input type="hidden" name="withheld_label_field" id="withheld_label_field" value="%">

                                <div class="input-group-addon">
                                  <div class="dropdown">
                                    <a class="dropdown-toggle" href="#" id="dropdown_menu_tax_total_type" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                      <span class="withheld-retention-type-selected" id="withheld-label">%
                                      </span>
                                      <span class="caret"></span>
                                    </a>
                                    <ul class="dropdown-menu" id="withheld-retention-type-dropdown" aria-labelledby="dropdown_menu_tax_total_type">
                                      <li>
                                        <a href="javascript:void(0)" class="withheld-retention-type withheld-retention-percent<?php if(!isset($invoice) || (isset($invoice) && is_sale_discount($invoice,'percent')) || (isset($invoice) && !is_sale_discount_applied($invoice))){echo ' selected';} ?>" onclick="updateAmountLabel('%','w')">%</a>
                                      </li>
                                      <li><a href="javascript:void(0)" class="withheld-retention-type withheld-retention-fixed<?php if(isset($invoice) && is_sale_discount($invoice,'fixed')){echo ' selected';} ?>" onclick="updateAmountLabel('Fixed Amount','w')">
                                          <?php echo _l('discount_fixed_amount'); ?>
                                        </a>
                                      </li>
                                    </ul>
                  ...
                  <td class="withheld-payment-total-text"><span id="withheld-payment-total-text">SAR0.00</span><input type="hidden" name="withheld_payment_total_field" id="withheld-payment-total-field" value="0"></td>
               </tr>
               <tr>
                  <td>
                     <div class="row">
                        <div class="col-md-7">
                           <span class="bold"><?php echo _l('Other Deductions'); ?></span>
                        </div>
                        <div class="col-md-5">
                           <input type="number" data-toggle="tooltip" data-title="<?php echo _l('numbers_not_formatted_while_editing'); ?>" value="<?php if(isset($invoice)){echo $invoice->adjustment; } else { echo 0; } ?>" class="form-control pull-left" name="other_deductions" onblur="otherDeductionsFunction(this.value)">
                        </div>
                     </div>
                  </td>
                  <td class="other_deductions"><span id="other-deductions-text">SAR0.00</span><input type="hidden" name="other_deductions_field" value="0" id="other-deductions-field"></td>
               </tr>
               <tr>
                  <td><span class="bold"><?php echo _l('Grand Total'); ?> :</span>
                  </td>
                  <td class="grand-total">
                    <span id="grand-total-text">SAR0.00</span><input type="hidden" name="grand_total_field" id="grand-total-field">
                  </td>
               </tr>
            </tbody>
         </table>
         ...
         <table class="table">
            <tr>
              <td>
                  <label class="bold"><?php echo _l('Original Contract Value'); ?></label>
                  <input type="number" name="original_contract_value" class="form-control" placeholder="Original Contract Value" />
              </td>
              <td>
                  <label class="bold"><?php echo _l('Billed till date'); ?></label>
                  <div class="input-group date">
                    <input type="text" id="billed_till_date" name="billed_till_date" class="form-control datepicker" autocomplete="off">
                    <div class="input-group-addon">
              ...
              <td>
                  <label class="bold"><?php echo _l('Paid till date'); ?></label>
                  <div class="input-group date">
                    <input type="text" id="paid_till_date" name="paid_till_date" class="form-control datepicker" autocomplete="off">
                    <div class="input-group-addon">
                      <i class="fa fa-calendar calendar-icon"></i>
                    </div>
                  </div>
              ...
              <td>
                  <label class="bold"><?php echo _l('Remaining till date'); ?></label>
                  <div class="input-group date">
                    <input type="text" id="remaining_till_date" name="remaining_till_date" class="form-control datepicker" autocomplete="off">
                    <div class="input-group-addon">
                      <i class="fa fa-calendar calendar-icon"></i>
                    </div>
                  </div>
