...
<div class="col-md-12">
   <div class="panel_s mbot10">
      <div class="panel-body _buttons">
         ...
         <?php } ?>
         <?php if(has_permission('invoices','','create')){ ?>
            <a href="<?php echo admin_url('invoices/import_individual_csv'); ?>" class="btn btn-info pull-left" style="margin-left:5px; display:none;"><?php echo _l('import_invoice'); ?></a>
         <?php } ?>
         <?php if(has_permission('invoices','','create')){ ?>
            <a href="<?php echo admin_url('invoices/import_bulk_csv'); ?>" class="btn btn-info pull-left" style="margin-left:5px; display:none;"><?php echo _l('import_bulk_invoice'); ?></a>
         <?php } ?>
