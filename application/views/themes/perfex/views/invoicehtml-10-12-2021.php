            ...
            <div class="col-md-12 col-sm-12 text-center" style="border: 0px solid #000000; background: #ffffff; color: #000000;">
               ...
               <table class="table" style="margin: 0px;">
                  <tr>
                     ...
                     <td width="33%" style=" background: #bfbfbf; padding: 0px; text-align: center; vertical-align: middle;"><h4 class="bold invoice-html-number">TAX INVOICE <br>فاتورة ضريبية </h4></td>
            ...
            <div class="col-md-12 col-sm-12 text-center" style="padding: 0px; padding-top: 15px;">
               <table class="table table-bordered invoice-detail-table">
                  ...
                  <tr>
                     ...
                     <td width="33%" class="invoice-table-column"><?php echo get_option('invoice_company_address'); ?></td>
            ...
            <div class="col-md-12 col-sm-12 text-center" style="padding: 0px;">
               <table class="table table-bordered invoice-detail-table">
                  <tr>
                     ...
                     <th width="20%" align="right" class="invoice-table-column"><b>: اسم الزبون </b></th>
                  </tr>
                  <tr>
            ...
            <div class="col-md-12 col-sm-12 text-center" style="padding: 0px;">
               <table class="table table-bordered invoice-detail-table">
                  <tr style="background: #bfbfbf; color: #000000">
                     ...
                     <th align="center" class="invoice-table-column"><b>Unit Rate <br> سعر الوحدة</b></th>
                     <th align="center" class="invoice-table-column"><b>Price Excl. Vat <br> السعر غير شامل ضريبة القيمة المضافة</b></th>
                     <th align="center" class="invoice-table-column"><b>VAT <br> ضريبة القيمة المضافة</b></th>
                     <th align="center" class="invoice-table-column"><b>VAT AMT <br> قيمة الضريبة</b></th>
                     <th align="center" class="invoice-table-column"><b>Amount Inclusive Vat <br> المبلغ شاملاً ضريبة القيمة المضافة</b></th>
                  </tr>
               <?php
               ...
               ?>
				...
				?>
                     <td align="center" class="invoice-table-column"><?php echo app_format_money($fif_percent_withheld, $invoice->currency_name); ?></td>
                     <td align="center" class="invoice-table-column"><?php echo app_format_money($tfif_percent_withheld, $invoice->currency_name); ?></td>
                  </tr>
               <?php
                     $sr++;
                  }
               ...
               ?>
                  ...
                  <tr>
                     ...
                     <th colspan="1" align="right" class="invoice-table-column" style="border: 1px solid #000000;"><b><?php echo app_format_money($withoutvat, $invoice->currency_name); ?></b></th>
                  </tr>
                  <tr>
                     <th colspan="3" style="border: 1px solid #000000;"></th>
                     ...
                     <th colspan="1" align="right" class="invoice-table-column" style="border: 1px solid #000000;"><b><?php echo app_format_money($fvattotal, $invoice->currency_name); ?></b></th>
                  </tr>
                  <tr>
                     <th colspan="3" style="border: 1px solid #000000;"></th>
                     ...
                     <th colspan="2" align="right" class="invoice-table-column" style="border: 1px solid #000000;"><b><?php echo app_format_money($final_amount, $invoice->currency_name); ?></b></th>
                  </tr>
                  <tr>
                     <th colspan="3" style="border: 1px solid #000000;"></th>
                     ...
                     <th colspan="1" align="right" class="invoice-table-column" style="border: 1px solid #000000; color: #ff0000;"><b><?php echo app_format_money($final_amount, $invoice->currency_name); ?></b></th>
                  </tr>
                  <tr>
                     <th colspan="5" class="invoice-table-column" style="border-right: 0px !important;">
                        <b>WE ENERGY Co. Ltd</b>
