...
$extrafields_data = $CI->invoices_model->get_extra_fields_data($invoice->id,'invoice');
...
$info_center_column = '<div>
               <table style="margin: 0px;">
                  <tr>
                     <td width="49.5%" style="padding-top: 10px;"><h3 style="color: #5690d7; font-size: 30px;">INVOICE</h3></td>
                     <td width="49.5%" style=" background-color: #ffffff; padding: 0px; text-align: right; vertical-align: middle; font-size: 22px; color: #5690d7;"><h4 class="bold invoice-html-number">AAO AL-LEHYANI EST</h4></td>
                  </tr>
               </table>
</div>';
...
$info_left_column = '<div style="float: left; width: 100%; padding: 30px;">
               <table style="margin: 0px;">
                  <tr>
                     <td width="20%" align="center" style="background-color: #dce6f1; border: 1px solid #000000;">DATE & TIME</td>
                     <td width="20%" align="center" style="background-color: #dce6f1; border: 1px solid #000000;">INVOICE NO</td>
                     <td width="59%" rowspan="2" align="right" style="background-color: #ffffff; border-left: 1px solid #000000;">ADDRESS: Al Udaba St Al Aziziyyah <br> CITY: Jeddah STATE,Makkah ZIP,23342 <br> PHONE: (+966)59-00-97-492</td>
                  </tr>
                  <tr>
                     <td width="20%" align="center" style="border: 1px solid #000000;">02/02/2022 15:32</td>
                     <td width="20%" align="right" style="border: 1px solid #000000;">10038</td>
                  </tr>
                  <tr>
                     <td colspan="3"></td>
                  </tr>
               ...
               <table cellpadding="3px" style="font-size: 12px;">
                  <tr>
                     <th width="99%" colspan="2" align="center" class="invoice-table-column" style="background-color: #dce6f1; border: 1px solid #000000;">BILL TO</th>
                  </tr>
                  <tr>
                     <th width="20%" class="invoice-table-column" style="border: 1px solid #000000; background-color: #dce6f1;">COMPANY NAME:</th>
                     <th width="79%" align="center" class="invoice-table-column" style="border: 1px solid #000000; ">Integrated Computer Systems</th>
                  </tr>
                  <tr>
                     <th width="20%" class="invoice-table-column" style="border: 1px solid #000000; background-color: #dce6f1;">STREET ADDRESS:</th>
                     <th width="79%" align="center" class="invoice-table-column" style="border: 1px solid #000000; ">75,Zuhair Bin Abi Salma St.Al Maseef Dist.</th>
                  </tr>
                  <tr>
                     <th width="20%" class="invoice-table-column" style="border: 1px solid #000000; background-color: #dce6f1;">CITY, STATE, ZIP:</th>
                     <th width="79%" align="center" class="invoice-table-column" style="border: 1px solid #000000; ">Riyadh, Kingdom Of Saudi Arabia.</th>
                  </tr>
                  <tr>
                     <th width="20%" class="invoice-table-column" style="border: 1px solid #000000; background-color: #dce6f1;">PHONE:</th>
                     <th width="79%" align="center" class="invoice-table-column" style="border: 1px solid #000000; ">966569280000</th>
                  </tr>
                  <tr>
                     <th width="20%" class="invoice-table-column" style="border: 1px solid #000000; background-color: #dce6f1;">EMAIL ADDRESS:</th>
                     <th width="79%" align="center" class="invoice-table-column" style="border: 1px solid #000000; "></th>
                  </tr>
               </table>
            </div>';
...
$info_left_column1 .= '<div style="float: left; width: 100%; padding: 30px;">
               <table class="table table-bordered invoice-detail-table" cellpadding="1.5px" style="font-size: 12px;">
                  <tr style="background-color: #dce6f1; color: #000000">
                     <th width="8%" align="left" class="invoice-table-column"><b>SR. No</b></th>
                     <th width="61%" align="center" class="invoice-table-column"><b>DESCRIPTION</b></th>
                     <th width="10%" align="center" class="invoice-table-column"><b>PRICE</b></th>
                     <th width="10%" align="center" class="invoice-table-column"><b>QUANTITY</b></th>
                     <th width="10%" align="center" class="invoice-table-column"><b>AMMOUNT</b></th>
                  </tr>';
                     ...
                     foreach ($invoice->items as $row) {
                        $excvat = $row["qty"] * $row["rate"];
                        $sub_sub_total = $sub_sub_total + $excvat;
         
                  $info_left_column1 .= '<tr>
                     <td align="right" class="invoice-table-column" style="border: 1px solid #000000;">'.$sr.'</td>
                     <td align="center" class="invoice-table-column" style="border: 1px solid #000000;">'.$row["description"].'<br />'.$row["long_description"].'</td>
                     <td align="right" class="invoice-table-column" style="border: 1px solid #000000;">'.app_format_money($row["rate"], '').'</td>
                     <td align="right" class="invoice-table-column" style="border: 1px solid #000000;">'.app_format_money($row["qty"], '').'</td>
                     <td align="right" class="invoice-table-column" style="border: 1px solid #000000;">'.app_format_money($excvat, '').'</td>
                  </tr>';
...
$info_left_column1 .= '
                  <tr>
                     <td colspan="2"></td>
                     <td colspan="2" align="center" class="invoice-table-column" style="border: 1px solid #000000;">Total Amount</td>
                     <td align="right" class="invoice-table-column" style="border: 1px solid #000000;">'.app_format_money($sub_sub_total, '').'</td>
                  </tr>
                  <tr>
                     <td colspan="2"></td>
                     <td colspan="2" align="center" class="invoice-table-column" style="border: 1px solid #000000;">80% Invoice</td>
                     <td align="right" class="invoice-table-column" style="border: 1px solid #000000;">'.app_format_money('46912.00', '').'</td>
                  </tr>
                  <tr>
                     <td colspan="2"></td>
                     <td colspan="2" align="center" class="invoice-table-column" style="border: 1px solid #000000;">VAT 15%</td>
                     <td align="right" class="invoice-table-column" style="border: 1px solid #000000;">'.app_format_money('7036.80', '').'</td>
                  </tr>
                  <tr>
                     <td colspan="2"></td>
                     <td colspan="2" align="center" class="invoice-table-column" style="border: 1px solid #000000;">Balance</td>
                     <td align="right" class="invoice-table-column" style="border: 1px solid #000000;">'.app_format_money('11728.00', '').'</td>
                  </tr>
                  <tr>
                     <td colspan="2"></td>
                     <td colspan="2" align="center" class="invoice-table-column" style="border: 1px solid #000000;">Received Amount</td>
                     <td align="right" class="invoice-table-column" style="border: 1px solid #000000;">'.app_format_money($sub_sub_total, '').'</td>
                  </tr>
                  <tr>
                     <td colspan="2"></td>
                     <td colspan="2" align="center" class="invoice-table-column" style="border: 1px solid #000000;">Due Invoice Amount</td>
                     <td align="right" class="invoice-table-column" style="border: 1px solid #000000;">'.app_format_money($sub_sub_total, '').'</td>
                  </tr>';
$info_left_column1 .= '
                  <tr>
                     <th width="40%" colspan="5" class="invoice-table-column" style="border: 1px solid #000000;">';
