   ...
   <div class="panel-body">
      <div class="col-md-10 col-md-offset-1">
         ...
         <div class="col-md-12 col-sm-12 text-center">
               <h4 class="bold invoice-html-number">فاتورة ضريبية <br> Tax Invoice</h4>
            </div>
            <div class="col-md-8 col-sm-8 transaction-html-info-col-left" style="margin-top:50px;">
               <div class="col-md-3 col-sm-3" style="border: 1px solid #000">
                  <b>Invoice Number:</b> 
               </div>
               <div class="col-md-3 col-sm-3" style="border: 1px solid #000">
                  <b><?php echo format_invoice_number($invoice->id); ?></b> 
               </div>
               <div class="col-md-3 col-sm-3 text-right" style="border: 1px solid #000">
               <b><?php echo format_invoice_number($invoice->id); ?> </b>
               </div>
               <div class="col-md-3 col-sm-3 text-right" style="border: 1px solid #000">
               <b>رقم الفاتورة </b>
            ...
            <div class="col-md-4 col-sm-4 transaction-html-info-col-right text-right" style="margin-top:50px;">
            ...
            <div class="col-md-8 col-sm-8 transaction-html-info-col-left">
               <div class="col-md-3 col-sm-3" style="border: 1px solid #000; border-top:none">
                  <b>Due Date:</b> 
               </div>
               <div class="col-md-3 col-sm-3" style="border: 1px solid #000; border-top:none">
                  <b><?php echo _d($invoice->duedate); ?></b> 
               </div>
               <div class="col-md-3 col-sm-3 text-right" style="border: 1px solid #000; border-top:none">
               <b><?php echo _d($invoice->duedate); ?> </b>
               </div>
               <div class="col-md-3 col-sm-3 text-right" style="border: 1px solid #000; border-top:none">
               <b>تاريخ الاستحقاق</b>
            ...
            <div class="col-sm-6 text-left transaction-html-info-col-left" >
            ...
            <div class="col-sm-6 text-left transaction-html-info-col-right">
            <!--   
