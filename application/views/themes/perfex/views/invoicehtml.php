   ...
   <div class="panel-body">
      <div class="col-md-10 col-md-offset-1">
         <div class="row mtop20">
            <div class="col-md-12 col-sm-12 text-center" style="border: 2px solid #000000; background: #bfbfbf; color: #000000;">
               <h4 class="bold invoice-html-number">TAX INVOICE <br>فاتورة ضريبية </h4>
            </div>
            <div class="col-md-12 col-sm-12 text-center" style="padding: 0px; padding-top: 15px;">
               <table class="table table-bordered invoice-detail-table">
                  <tr>
                     ...
                     <td width="33%" align="center" class="invoice-table-column" style="border: 1px solid #000000;"><?php echo get_option('invoice_company_name'); ?></td>
                     <th width="33%" align="right" class="invoice-table-column" style="border: 1px solid #000000;"><b>:البائع اسم</b></th>
                  </tr>
                  <tr>
                     <th width="33%" class="invoice-table-column"><b>Invoice No:</b></th>
                     <td width="33%" class="invoice-table-column"><?php echo format_invoice_number($invoice->id); ?></td>
                     <th width="33%" align="right" class="invoice-table-column"><b>:رقم الفاتورة </b></th>
                  </tr>
                  <tr>
                     <th width="33%" class="invoice-table-column"><b>Date of Invoice:</b></th>
                     <td width="33%" class="invoice-table-column"><?php echo date('d/m/Y', strtotime($invoice->date)); ?></td>
                     <th width="33%" align="right" class="invoice-table-column"><b>: تاري خ الفاتورة </b></th>
                  </tr>
                  <tr>
                     <th width="33%" class="invoice-table-column"><b>Invoice for the period:</b></th>
                     <td width="33%" class="invoice-table-column"><?php echo date('01/m/Y'); ?> - <?php echo date('t/m/Y'); ?></td>
                     <th width="33%" align="right" class="invoice-table-column"><b>:فاتورة الف رية</b></th>
                  </tr>
                  <tr>
                     <th width="33%" class="invoice-table-column"><b>Huta Marine Works Ltd. VAT No.</b></th>
                     <td width="33%" class="invoice-table-column">------------------</td>
                     <th width="33%" align="right" class="invoice-table-column"><b>:رقم ال ر ضي ي ب ل ر شكة هوتا للاعمال البحريه المحدود</b></th>
                  </tr>
               </table>
            </div>
            <div class="col-md-12 col-sm-12 text-center" style="border: 2px solid #000000; background: #ffffff; color: #000000">
               <h4 class="bold invoice-html-number" style="margin: 5px;">Customer Details / تفاصيل العميل</h4>
            </div>
            <div class="col-md-12 col-sm-12 text-center" style="padding: 0px;">
               <table class="table table-bordered invoice-detail-table">
                  <tr>
                     <th width="20%" class="invoice-table-column"><b>Company Name:</b></th>
                     <td width="60%" class="invoice-table-column"><b><?php echo get_option('invoice_company_name')?></b></td>
                     <th width="20%" align="right" class="invoice-table-column"><b>: راسم الزبون </b></th>
                  </tr>
                  <tr>
                     ...
                     <th width="20%" align="right" class="invoice-table-column"><b>:ترقم ال ر ضي ي ب :</b></th>
                  </tr>
                  <tr>
                  ...
                  <tr>
                     <th width="20%" class="invoice-table-column"><b>Attn:</b></th>
                     <td width="60%" class="invoice-table-column">-----</td>
                     <th width="20%" align="right" class="invoice-table-column"><b>: ملاحظة </b></th>
                  </tr>
               </table>
            </div>
            <div class="col-md-12 col-sm-12 text-center" style="padding: 0px;">
               <table class="table table-bordered invoice-detail-table">
                  <tr style="background: #bfbfbf; color: #000000">
                     ...
                     <th align="center" class="invoice-table-column"><b>Service Description</b></th>
                     <th align="center" align="right" class="invoice-table-column"><b>QTY</b></th>
                     <th align="center" class="invoice-table-column"><b>Unit Rate</b></th>
                     <th align="center" class="invoice-table-column"><b>Price Excl. Vat</b></th>
                     <th align="center" class="invoice-table-column"><b>VAT</b></th>
                     <th align="center" class="invoice-table-column"><b>VAT AMT</b></th>
                     <th align="center" class="invoice-table-column"><b>Amount Inclusive Vat</b></th>
                  </tr>
               <?php
               ...
               ?>
                  <tr>
                     ...
                     <td align="center" class="invoice-table-column"><?php echo $row["qty"]; ?></td>
                     <td align="center" class="invoice-table-column"><?php echo app_format_money($row["rate"], $invoice->currency_name); ?></td>
                     <td align="center" class="invoice-table-column"><?php echo app_format_money($excvat, $invoice->currency_name); ?></td>
                     <td align="center" class="invoice-table-column"><?php foreach ($items->taxes() as $tax) { echo app_format_number($tax['taxrate']) . '%'; $price_excl_vat = $price_excl_vat + $tax['taxrate']; } ?></td>
                     <td align="center" class="invoice-table-column"><?php echo app_format_money($invoice->total_tax, $invoice->currency_name); ?></td>
                     <td align="center" class="invoice-table-column"><?php echo app_format_money($invoice->subtotal, $invoice->currency_name); ?></td>
                  </tr>
               <?php
                     $sr++;
                  }
               ...
               ?>
                  <tr style="background: #f2f2f2; color: #000000">
                     <th colspan="4" align="center" class="invoice-table-column"><b>Gross Invoice for the Period <br> الفاتورة الإجمالية للف رية</b></th>
                     <th align="center" class="invoice-table-column"><b><?php echo app_format_money($price_excl_vat, $invoice->currency_name); ?></b></th>
                     <th align="center" class="invoice-table-column"><b></b></th>
                     <th align="center" class="invoice-table-column"><b><?php echo app_format_money($vat_amt, $invoice->currency_name); ?></b></th>
                     <th align="center" class="invoice-table-column"><b><?php echo app_format_money($amount_inclusive_vat, $invoice->currency_name); ?></b></th>
                  </tr>
                  <tr style="background: #f2f2f2; color: #000000">
                     <th colspan="4" align="center" class="invoice-table-column"><b>Net Invoice for the Period <br> صاف الفاتورة للف رية</b></th>
                     <th align="center" class="invoice-table-column"><b><?php echo app_format_money($price_excl_vat, $invoice->currency_name); ?></b></th>
                     <th align="center" class="invoice-table-column"><b></b></th>
                     <th align="center" class="invoice-table-column"><b><?php echo app_format_money($vat_amt, $invoice->currency_name); ?></b></th>
                     <th align="center" class="invoice-table-column"><b><?php echo app_format_money($amount_inclusive_vat, $invoice->currency_name); ?></b></th>
                  ...
                  <tr>
                     <td colspan="7" class="invoice-table-column">Amount withheld as Retention - 5 % <br> خصم الاستبقاء</td>
                     <th align="right" class="invoice-table-column">(<?php echo app_format_money($five_percent_withheld, $invoice->currency_name); ?>)</th>
                  </tr>
                  <tr>
                     <td colspan="7" class="invoice-table-column">Other Deductions <br> استقطاعات أخرى</td>
                     <th align="right" class="invoice-table-column">(SAR0.00)</th>
                  </tr>
                  <tr>
                     <td colspan="7" class="invoice-table-column">Net Amount Due <br> المبلغ المتب رق المستحق</td>
                     <th align="right" class="invoice-table-column"><b><?php echo app_format_money($final_amount, $invoice->currency_name); ?></b></th>
                  </tr>
                  <tr>
                     <td colspan="8" class="invoice-table-column">Saudi Riyals: One Million Four Hundred Twenty Four Thousand Eight Hundred Seventy Five & 00/100 only <br> فقط مليون وأربعمائة وأربعة وع ر شون ألف ) وثمانيةمائة وخمسة وسبعون و صفر هللة لا غ رت(</td>
                  </tr>
                  <tr>
                     <th colspan="3" class="invoice-table-column">
                     ...
                     <th colspan="3" class="invoice-table-column" align="center"></th>
                     <th colspan="2" class="invoice-table-column" align="center">
