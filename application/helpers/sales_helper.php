...
//        $format = _info_format_replace('company_name', '<b style="color:black; border:1px solid #000;" class="company-name-formatted">' . get_option('invoice_company_name') . '</b>', $format);
        $format = _info_format_replace('company_name', '<div style="float:left; color:black; border:1px solid #000; width:50%;" class="company-name-formatted">' . get_option('invoice_company_name') . '</div>', $format);
        $format = _info_format_replace('address', '<div style="float:left; color:black; border:1px solid #000; width:50%;" class="company-name-formatted">' . get_option('invoice_company_address') . '</div>', $format);
