...
class Project_data_pdf extends App_pdf
{
    ...
    public function prepare()
    {
        ...
        $data['files'] = $this->ci->projects_model->get_files($project->id);
        $data['discussions'] = $this->ci->projects_model->get_discussions($project->id);
        $data['tickets'] = $this->ci->projects_model->get_tickets($project->id);
        $data['contracts'] = $this->ci->projects_model->get_contracts($project->id);
