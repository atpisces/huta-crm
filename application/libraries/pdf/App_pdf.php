...
abstract class App_pdf extends TCPDF
{
    ...
    public function Header()
    {
        ...
        $header_info = '<br><br><div style="float: left; width: 100%; padding: 30px;">
               <table cellpadding="15px">
                  <tr style="background-color: #bfbfbf; color: #000000;">
                     <th width="99%" align="center" class="invoice-table-column" style="border: 1px solid #000000;"><b>TAX INVOICE <br>فاتورة ضريبية</b></th>
                  </tr>
                </table>
        </div>';
        
        $this->writeHTML($header_info, true, false, true, false, '');
        // Title
