...
class Dashboard_model extends App_Model
{
    ...
    function get_all_notes(){
        return $this->db->query('SELECT * FROM ' . db_prefix() . 'notes N INNER JOIN ' . db_prefix() . 'clients C ON C.userid = N.rel_id INNER JOIN ' . db_prefix() . 'staff S ON S.staffid = N.addedfrom WHERE N.rel_type = "customer" ORDER BY N.id DESC')->result_array();
    }
