        ...
        if ($insert_id) {
            ...
            for($i=0;$i<count($extrafields);$i++){
                if($extrafields[$i] != ""){
                    ...
                    $extra_fields_data = array("invoiceid" => $insert_id,"invoicetype" => "credit_note", "fieldtype" => $extrafields[$i], "fielddescription" => $extradescription[$i], "fieldamount" => $extraamounts[$i], "fieldvat" => $extravats[$i]);
