...
class Dashboard extends AdminController
{
    ...
    public function index()
    {
        ...
        $data['all_notes'] = $this->dashboard_model->get_all_notes();

        $data = hooks()->apply_filters('before_dashboard_render', $data);
        $this->load->view('admin/dashboard/dashboard', $data);
    }

    public function list_of_notes(){
        if ($this->input->is_ajax_request()) {
            $this->app->get_table_data('notes');
        }
        $data['title'] = _l('Notes');
        $this->load->view('admin/tables/notes', $data);
    }
    ...
    public function list_of_tasks(){
        ...
        $data['title'] = _l('Tasks');
        $this->load->view('admin/dashboard/manage_tasks', $data);
    }
