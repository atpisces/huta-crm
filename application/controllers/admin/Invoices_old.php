...
class Invoices extends AdminController
{
    ...
    {
        // print_r($this->input->post('extra_fields_type'));
        // $extrafields = $this->input->post('extra_fields_type');
        // $extraamounts = $this->input->post('extra_fields_amount');
        // $extravats = $this->input->post('extra_fields_vat');
        // for($i=0;$<=count($extrafields);$i++){

        // }
        $data = $this->input->post();
        // print_r($data['extra_fields_type']);
        ...
        //     $arr = array("invoiceid" => $insert_id, "fieldtype" => $extrafields[$i], "fieldtype" => $extraamounts[$i], "fieldvat" => $extravats[$i]);
        ...
        if ($id == '') {
            ...
            $data['extra_fields_data']  = $this->invoices_model->get_extra_fields_data($invoice->id);
