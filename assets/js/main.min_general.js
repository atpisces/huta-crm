...
function addMoreExpense(){
	var html = '<hr /><div class="panel-body"><hr class="hr-panel-heading"><div id="dropzoneDragArea" class="dz-default dz-message dz-clickable"><span>Attach Receipt</span></div><div class="dropzone-previews"></div><hr class="hr-panel-heading"><div class="row"><div class="col-md-12"><lable for="vendor">Vendors<div class="dropdown bootstrap-select bs3" style="width: 100%;"><select name="vendor" id="vendor" data-width="100%" class="selectpicker" data-live-search="true" data-none-selected-text="None" tabindex="-98"><option value=""></option></select><button type="button" class="btn dropdown-toggle btn-default bs-placeholder" data-toggle="dropdown" role="combobox" aria-owns="bs-select-2" aria-haspopup="listbox" aria-expanded="false" data-id="vendor" title="None"><div class="filter-option"><div class="filter-option-inner"><div class="filter-option-inner-inner">None</div></div> </div><span class="bs-caret"><span class="caret"></span></span></button><div class="dropdown-menu open"><div class="bs-searchbox"><input type="search" class="form-control" autocomplete="off" role="combobox" aria-label="Search" aria-controls="bs-select-2" aria-autocomplete="list"></div><div class="inner open" role="listbox" id="bs-select-2" tabindex="-1"><ul class="dropdown-menu inner " role="presentation"></ul></div></div></div></lable></div></div><br><i class="fa fa-question-circle pull-left" data-toggle="tooltip" data-title="For personal usage - If billable, Name can be added to invoice long description."></i><div class="form-group" app-field-wrapper="expense_name"><label for="expense_name" class="control-label">Name</label><input type="text" id="expense_name" name="expense_name" class="form-control" value=""></div>                  <i class="fa fa-question-circle pull-left" data-toggle="tooltip" data-title="If billable, Note can be added to invoice long description."></i><div class="form-group" app-field-wrapper="note"><label for="note" class="control-label">Note</label><textarea id="note" name="note" class="form-control" rows="4"></textarea></div>                  <div class="form-group form-group-select-input-category input-group-select"><label for="category" class="control-label"> <small class="req text-danger">* </small>Expense Category</label><div class="input-group input-group-select select-category" app-field-wrapper="category"><div class="dropdown bootstrap-select input-group-btn _select_input_group bs3 bs3-has-addon" style="width: 100%;"><select id="category" name="category" class="selectpicker _select_input_group" data-width="100%" data-none-selected-text="Nothing selected" data-live-search="true" tabindex="-98"><option value=""></option><option value="">Petty Cash</option></select><button type="button" class="btn dropdown-toggle btn-default bs-placeholder" data-toggle="dropdown" role="combobox" aria-owns="bs-select-3" aria-haspopup="listbox" aria-expanded="false" data-id="category" title="Nothing selected"><div class="filter-option"><div class="filter-option-inner"><div class="filter-option-inner-inner">Nothing selected</div></div> </div><span class="bs-caret"><span class="caret"></span></span><div class="filter-expand">Nothing selected</div></button><div class="dropdown-menu open"><div class="bs-searchbox"><input type="search" class="form-control" autocomplete="off" role="combobox" aria-label="Search" aria-controls="bs-select-3" aria-autocomplete="list"></div><div class="inner open" role="listbox" id="bs-select-3" tabindex="-1"><ul class="dropdown-menu inner " role="presentation"></ul></div></div></div><div class="input-group-addon" style="opacity: 1;"><a href="#" onclick="new_category();return false;"><i class="fa fa-plus"></i></a></div></div></div>                                    <div class="form-group" app-field-wrapper="date"><label for="date" class="control-label"> <small class="req text-danger">* </small>Expense Date</label><div class="input-group date"><input type="text" id="date" name="date" class="form-control datepicker" value="17-02-2022" autocomplete="off"><div class="input-group-addon"><i class="fa fa-calendar calendar-icon"></i></div></div></div>                  <div class="form-group" app-field-wrapper="amount"><label for="amount" class="control-label"> <small class="req text-danger">* </small>Amount</label><input type="number" id="amount" name="amount" class="form-control" value=""></div>                  <div class="checkbox checkbox-primary billable hide"><input type="checkbox" id="billable" name="billable"><label for="billable">Billable</label></div><div class="form-group"><label for="clientid" class="control-label">Customer</label><div class="dropdown bootstrap-select ajax-search bs3 dropup" style="width: 100%;"><select id="clientid" name="clientid" data-live-search="true" data-width="100%" class="ajax-search" data-none-selected-text="Nothing selected" tabindex="-98" title="Select and begin typing"><option class="bs-title-option" value=""></option></select><button type="button" class="btn dropdown-toggle bs-placeholder btn-default" data-toggle="dropdown" role="combobox" aria-owns="bs-select-10" aria-haspopup="listbox" aria-expanded="false" data-id="clientid" title="Select and begin typing"><div class="filter-option"><div class="filter-option-inner"><div class="filter-option-inner-inner">Select and begin typing</div></div> </div><span class="bs-caret"><span class="caret"></span></span></button><div class="dropdown-menu open" style="min-height: 55px; max-height: 846.859px; overflow: hidden;"><div class="bs-searchbox"><input type="search" class="form-control" autocomplete="off" role="combobox" aria-label="Search" aria-controls="bs-select-10" aria-autocomplete="list" placeholder="Type to search..."></div><div class="inner open" role="listbox" id="bs-select-10" tabindex="-1" style="min-height: 0px; max-height: 790.859px; overflow-y: auto;"><ul class="dropdown-menu inner " role="presentation"></ul></div><div class="status" style="">Start typing to search</div></div></div></div><div class="form-group projects-wrapper hide"><label for="project_id">Project</label><div id="project_ajax_search_wrapper"><div class="dropdown bootstrap-select projects ajax-search bs3" style="width: 100%;"><select name="project_id" id="project_id" class="projects ajax-search" data-live-search="true" data-width="100%" data-none-selected-text="Nothing selected" tabindex="-98" title="Select and begin typing"><option class="bs-title-option" value=""></option></select><button type="button" class="btn dropdown-toggle bs-placeholder btn-default" data-toggle="dropdown" role="combobox" aria-owns="bs-select-1" aria-haspopup="listbox" aria-expanded="false" data-id="project_id" title="Select and begin typing"><div class="filter-option"><div class="filter-option-inner"><div class="filter-option-inner-inner">Select and begin typing</div></div> </div><span class="bs-caret"><span class="caret"></span></span></button><div class="dropdown-menu open" style="min-height: 55px; max-height: 392px; overflow: hidden;"><div class="bs-searchbox"><input type="search" class="form-control" autocomplete="off" role="combobox" aria-label="Search" aria-controls="bs-select-1" aria-autocomplete="list" placeholder="Type to search..."></div><div class="inner open" role="listbox" id="bs-select-1" tabindex="-1" style="min-height: 0px; max-height: 336px; overflow-y: auto;"><ul class="dropdown-menu inner " role="presentation"></ul></div><div class="status" style="">Start typing to search</div></div></div></div></div></div>';
	$("#moreexpenses").append(html);
}

//alert(rinc);
function addMoreRows(){
$("#allrows").append('<tr id="rowsection'+rinc+'"><td><select name="extra_fields_type[]" class="form-control"><option value="" selected>Select Type</option><option value="Recovery">Recovery</option><option value="Retention">Retention</option><option value="Deduction">Deduction</option></select></td><td><textarea name="extra_fields_description[]" class="form-control" rows="2" placeholder="Description"></textarea></td><td><input type="text" name="extra_fields_amount[]" class="form-control" placeholder="Amount"></td><td><input type="number" name="extra_fields_vat[]" class="form-control" placeholder="VAT"></td><td><div><a href="javascript:void(0)" style="background-color: #bb2d3b; color: #ffffff; padding: 5px; border-radius: 5px;" onclick="removeSection('+rinc+')"><i class="fa fa-trash fa-1x"></i></a></div></td></tr>');
rinc++;
}

function removeSection(r){
$("#rowsection"+r).remove();
}
